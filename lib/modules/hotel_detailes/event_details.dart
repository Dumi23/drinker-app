...
class EventDetails extends StatefulWidget {
  ...
  const EventDetails(
      {Key? key, required this.eventData, required this.placeData})
      : super(key: key);
  @override
  _HotelDetailesState createState() => _HotelDetailesState();
}

class _HotelDetailesState extends State<EventDetails>
          ...
          button = CommonButton(
              ...
              onTap: () {
                NavigationServices(context)
                    .gotoRoomBookingScreen(widget.eventData.name);
              });
        });
      } else {
        setState(() {
    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          CommonCard(
            ...
            child: ListView(
              ...
              children: <Widget>[
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                      children: [
                        TextSpan(
                          text: utf8
                              .decode(widget.eventData.description.codeUnits),
                ...
                _getPhotoReviewUi("Atendees", 'view_all', Icons.arrow_forward,
                    () {
                  NavigationServices(context)
                      .goToAtendeesListScreen(widget.eventData);
                }),

                // feedback&Review data view
                for (var atendee in widget.eventData.atendees)
                  AtendeeView(
                    attende: atendee,
          ...
          _backgraoundImageUI(widget.eventData),
  ...
  Widget _backgraoundImageUI(Event eventData) {
    return Positioned(
      top: 0,
      left: 0,
      right: 0,
                      ...
                      children: <Widget>[
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: Image.network(
                              "https://5cw4rvtc-8000.euw.devtunnels.ms/${eventData.image}",
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
